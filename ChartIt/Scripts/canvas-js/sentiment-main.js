...
//  over the visualization legend
  ...
  $("#tweet-legend").qtip( {
    content: "Pleasant tweets are green, and unpleasant tweets are fuscia. Larger or more opaque tweets represent more confident sentiment estimates, while smaller or more transparent tweets represent less confident estimates.",
    show: { delay: 665 },
