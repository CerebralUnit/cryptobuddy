...
namespace CryptoCompare
{
    ...
    public class CoinsClient : BaseApiClient, ICoinsClient
    {
        ...
        public async Task<CoinSocialStatsResponse> SocialStats(int id)
        {
            return await this.GetAsync<CoinSocialStatsResponse>(ApiUrls.SocialStats(id)).ConfigureAwait(false);
        }
    }
}
